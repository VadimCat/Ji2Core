...
namespace Ji2.Audio
{
    public class Sound : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("_playbackSource")] [SerializeField] private SfxPlaybackSource playbackSource;
        ...
        {
            _sfxPlaybackPool = new Pool<SfxPlaybackSource>(playbackSource, transform);
            _audioSettings = new();
